  ...
  return (
    <>
      ...
      <p>触手に触れた人間に精神状態を変容させる毒物を注入できる。
        その中には、ナメクジが交尾の際に感ずる快楽や、
        何も準備してないのにいきなり発表させられる夢を見たときの不安、
        「こちら側のどこからでも切れます」で頭の血管が切れた時の怒りを感じさせるものがある。
        一部の専門家は、彼女の姿を見ただけでも同様の効果があると主張している。
        研究によると頭が腐るような感覚を覚えることがあるらしく、
        この現象はブレインロットと名付けられ、後に転用されて2024年のオックスフォード・ワード・オブ・ザ・イヤーに選出された。
        表彰式に登壇した彼女は「なんでポイントカードって溜まった瞬間に使えないんですか！？」と問題提起を行った。
        この発言が現代の消費社会を象徴するものとして高く評価され、名誉博士号（金融工学）を授与された。
      </p>
