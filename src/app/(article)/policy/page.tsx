...
export default function PolicyPage() {
  return (
    <>
      ...
      <h2>お詫び</h2>
      <p>
        過去、音声合成ソフトを用いて出力した音声を利用した音楽作品についてCCライセンスを表示していましたが、
        これらの音声はCC非互換である可能性が高いと独自に判断したため、2026年6月3日をもって表示を取り下げました。
        CCは取り消し不能なライセンスとされていますが、これらについてはそもそもライセンスが有効でなかった可能性が高いため、この原則は適用されないものと判断しています。
        現時点でこれらの作品の二次利用は確認していないため、実質的な問題は発生していないというのが私の見解ですが、
        権利者様や利用を検討されていた皆様にお詫び申し上げます。
        なお、これらの作品のうち歌唱音声以外の要素については、引き続きCCライセンスで利用可能です。
      </p>
    </>
  );
}
